 ...
 */
public class sorting_optimized{
    ...
    // this optimized bubble sort by ending the sort if no passes happen. an early exit
    public static void optbubbleSort(int[] arr) {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            if (!swapped) {
                break; // No swaps: array sorted
            }
        }
    }
    
    // this optimized bubble sort tracks last swapped and moves larger items to the right
    /*public static void optbubbleSort(int[] arr) {
    int n = arr.length;
    int newN;
    do {
...
*/
    ...
    public static void main(String[] args) {
        ...
        //  test bubble sort
        String[] algorithms = {"bubble", "quick", "optimized_bubble"};
